...
async def upload_file(file: UploadFile = File(...)):
    ...
    print("Assistant Chunks Generated ✅")
    print("Number of Chunks:", len(assistant_chunks))
    print("Preview of First Chunk:", assistant_chunks[0] if assistant_chunks else "No chunks found")
